...
const page = () => {
          ...
          if (messageTranscript && messageCourseLetter && messageCourse) {
            ...
            const data = {
              ...
              if (
                ...
                parseFloat(gpa[0].AA) <=
                  parseFloat((totalQualityPoints / studentTotalCredits).toFixed(2))
              ) {
                isGraduated = true;
              }
  ...
  const handleSubmit2 = () => {
    ...
    axios
      .post(`/api/exams/grading/5`, results2);
      axios
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('AA', e.target.value)}
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('BA', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('BB', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('CB', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('CC', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('DC', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('DD', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('FD', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
              ...
              <tr>
                ...
                <td className="border border-gray-300 px-4 py-2 ">
                  <select
                    id="dep"
                    dir="rtl"
                    onChange={(e) => handleChangeResults('FF', e.target.value)}
                    className="text-right px-4 py-2 bg-lightBlue w-[100px]"
