...
const Tabs = ({ params }: { params: { id: number, name:string } }) => {
  ...
  return (
    <div className="flex lg:absolute flex-col justify-center items-center lg:w-[80%] sm:w-[100%] sm:text-[8px] lg:text-[16px]">
      <Link
        href={`/doctor/head-of-department-work/pervClassStudents/${params.id}/${params.name}`}
